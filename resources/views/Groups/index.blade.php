...
<div class="card" style="width: 18rem;">
  <div class="card-body">
    <a style="text-decoration:none" href="/groups/{{$group['id']}}" class="card-title">{{ $group['name'] }}</a>
        ...
        <ul class="list-group">
          @foreach ($group->friends as $friend)
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
              ...
              @csrf
              @method('PUT')
              <button type="submit" class="badge card-link btn-danger">X</a>
              </form>
            </li>  
          @endforeach
        </ul>
    <hr>
    <a style="text-decoration:none" href="/groups/{{$group['id']}}/edit" class="card-link btn-warning">Edit group</a>
